...
def trainer():
    ...
    # Add data.csv to the project folder
...
# Main (initial) tkinter instruction pointer starts here
root = Tk()
choice = StringVar()
frame = ttk.Frame(root)
frame.pack()
frame.config(height = 600, width = 800)	# Initial window size, change for full screen but is not required hence rejected
